...
class ScanNet2D3DChunks(Dataset):
    ...
    def _load_dataset(self):
        with open(osp.join('/home/dchangyu/MV-KPConv/',self.cache_dir, 'scannetv2_{}.pkl'.format(self.split)), 'rb') as f:
...
def test_ScanNet2D3DChunksTest():
    ...
    for i in range(len(dataset)):
        ...
        for data in data_list:
            ...
            #name = 'pc'+str(i)+'.ply'
            #o3d.io.write_point_cloud('/home/dchangyu/MV-KPConv/'+name, pc_with_labels(points, seg_label, style='scannet'))
...
def test_ScanNet2D3DWhole():
    ...
    for i in range(1):
        ...
        # o3d.io.write_point_cloud('/home/dchangyu/MV-KPConv/' + name, pcd_scene)
        # name2 = 'pc_image' + str(i) + '.ply'
        # o3d.io.write_point_cloud('/home/dchangyu/MV-KPConv/' + name2, pcd_xyz)



        #visualize_point_cloud(image_xyz_valid)
        name = 'pc_image_color'+str(i)+'.ply'
        o3d.io.write_point_cloud('/home/dchangyu/MV-KPConv/'+name, pc_with_labels(image_xyz.reshape(-1, 3)[knn_indices[:, 2]], seg_label))
        ...
        #name = 'pc'+str(i)+'.ply'
        #o3d.io.write_point_cloud('/home/dchangyu/MV-KPConv/'+name, draw_point_cloud(image_xyz_valid.reshape(-1, 3)[knn_indices[:, 2]], [0., 1., 0.]))
