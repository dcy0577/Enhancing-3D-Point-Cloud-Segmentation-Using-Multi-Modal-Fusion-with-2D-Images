...
from datasets.Colmap_sphere_color import *
...
if __name__ == '__main__':
    ...
    chosen_log = 'results/rigid early +z'
    ...
    # config.in_radius = 2.000000
    config.validation_size = 50
    # config.input_threads = 3
    # config.batch_num = 4
    ...
    if config.dataset == 'ScanNet':
        ...
        test_sampler = ColmapSampler(test_dataset)
        collate_fn = ColmapCollate
    else:
