...
class KPFCNN_featureAggre(nn.Module):
    ...
    def __init__(self, config, lbl_values, ign_lbls):
        ...
        # checkpoint = torch.load('/home/dchangyu/MV-KPConv/outputs/scannet/unet_resnet34/model_best.pth',
    ...
    def forward(self, batch, config):
        ...
        # feature_3d can contain RGB, XYZ and additional constant 1 to insure black/dark points are not ignored
        # the demension of feature_3d is thus depending on settings in training script
        ...
        stacked_features = batch.feature_3d
        stacked_features = torch.cat((stacked_features, feature_2d3d),dim=1) # (np,66) feature dim = 1+z+64


        # Get input features
        x = stacked_features.clone().detach() # feature dim: 66
