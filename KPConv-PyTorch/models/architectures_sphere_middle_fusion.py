...
# ----------------------------------------------------------------------------------------------------------------------
#
#      Define middle fusion network architectures
#
# ----------------------------------------------------------------------------------------------------------------------
...
class KPFCNN_featureAggre(nn.Module):
    """
    Class defining KPFCNN middle fusion
    """
    ...
    def forward(self, batch, config):
        ...
        stacked_features_3d = batch.feature_3d # (np,4) feature dim = xyz+1
        ...
        # Get input features
        x_2d = stacked_features_2d.clone().detach() # feature dim: 65
        ...
        # before decoder, fuse the features using average
