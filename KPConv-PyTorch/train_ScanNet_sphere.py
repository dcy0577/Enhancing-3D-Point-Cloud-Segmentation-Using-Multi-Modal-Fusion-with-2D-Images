...
class ScanNetConfig(Config):
    ...
    # features dimension at first layer
    ...
    #in_features_dim = 65      # 64+1
    # in_features_dim = 68       # 64+3 RGB +1 when use_point_color=True; 64+3 XYZ +1 when use_point_color=False
    in_features_dim = 66          #64+1+z
    # in_features_dim = 69      # 64 + 3 color channels + z + 1
    # in_features_dim = 71     # 64+3 RGB + 3 XYZ +1
...
if __name__ == '__main__':
    ...
    previous_training_path = 'Log_2021-08-24_15-21-55'
    # previous_training_path = 'Log_2021-08-06_14-16-32'
    ...
    # Initialize datasets
    # The image_normalizer setting are derived from the ImageNet dataset,
    # which is the recommended setting if using the pre-trained model provided by PyTorch
