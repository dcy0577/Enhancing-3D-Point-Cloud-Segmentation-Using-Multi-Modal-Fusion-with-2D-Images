...
if __name__ == '__main__':
    ...
    # Initialize datasets
    training_dataset = ScanNetDataset(config, set='training', use_potentials=True) #use_potentials=True
    test_dataset = ScanNetDataset(config, set='validation', use_potentials=True) #use_potentials=True
