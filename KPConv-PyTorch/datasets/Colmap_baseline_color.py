...
class Colmap_baseline(PointCloudDataset):
    ...
    def __init__(self,
        ...
        # self.cloud_names = ['cms_Prof_label','cms_Alex_label']
        # self.cloud_names = ['cms_Prof_label']
...
class ColmapSampler(Sampler):
    ...
    def __init__(self, dataset: Colmap_baseline):
