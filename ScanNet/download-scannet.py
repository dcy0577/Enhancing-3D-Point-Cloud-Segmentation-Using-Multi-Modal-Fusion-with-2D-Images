...
def main():
    ...
    if args.task_data:  # download task data
        ...
        #scan_id = args.id
        #2021/3/5/ download the scene with windows and doors
        sceneWithDoorWindow = open(r'sceneWithDoorWindow.txt')
        scan_id_list = sceneWithDoorWindow.read().splitlines()
        sceneWithDoorWindow.close()
